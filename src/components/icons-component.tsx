...
export default function IconsComponent() {
    ...
    return (
        <div className="flex flex-wrap items-center gap-3 max-w-lg mx-auto select-none">
            ...
            <img loading="lazy" src="/icons/nextjs.svg" alt="Next.js" title="Next.js" className="w-10 h-10" />
            <img loading="lazy" src="/icons/tailwindcss.svg" alt="Tailwind CSS" title="Tailwind CSS" className="w-10 h-10" />
            <img loading="lazy" src="/icons/nodejs.svg" alt="Node.js" title="Node.js" className="w-10 h-10" />
            <img loading="lazy" src="/icons/postgresql.svg" alt="PostgreSQL" title="PostgreSQL" className="w-10 h-10" />
